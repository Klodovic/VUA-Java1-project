...
public class AddNewGenre extends javax.swing.JDialog {
    ...
    private void btnAddActorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActorActionPerformed
        if (isFormValid()) {
            ...
            for (Genre g : allGenres) {
                if (g.getGenreName().equals(txtName.getText().trim())) {
                    exists = true;
                }
            }
            if (!exists) {
                try {
                    repository.createNewGenre(txtName.getText().trim());
                    showInformationMessage("New genre", "The new genre has been successfully added!");
                    dispose();
                } catch (Exception ex) {
                    Logger.getLogger(AddNewGenre.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                lblInfo.setText("Genre already exists!");
                txtName.setText("");
                txtName.grabFocus();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewGenre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddNewGenre dialog = new AddNewGenre(new javax.swing.JFrame(), true);
