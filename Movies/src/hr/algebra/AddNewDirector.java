...
public class AddNewDirector extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add new director");

        jLabel12.setText("Director name");
    ...
    private void btnAddActorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActorActionPerformed
        if (isFormValid()) {
            ...
            for (Director d : allDirectors) {
                if (d.getDirectorName().equals(txtName.getText().trim())) {
                    exists = true;
                }
            }
            if (!exists) {
                try {
                    repository.createNewDirector(txtName.getText().trim());
                    showInformationMessage("New director", "The new director has been successfully added!");
                    dispose();
                } catch (Exception ex) {
                    Logger.getLogger(AddNewDirector.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                lblInfo.setText("Director already exists!");
                txtName.setText("");
                txtName.grabFocus();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewDirector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddNewDirector dialog = new AddNewDirector(new javax.swing.JFrame(), true);
